...
TECHNICAL_ARCHITECT_PROMPT = """You are a world-class Staff Software Architect. Your task is to analyze a Jira ticket and provide a detailed impact analysis and a high-level solution architecture.
...
PRODUCT_MANAGER_PROMPT = """You are a Senior Product Manager. Your task is to create a comprehensive Product Requirements Document (PRD) based on the provided Jira ticket, impact analysis, and solution architecture.
...
JIRA_ANALYST_SYSTEM_PROMPT = """You are an expert Jira Analyst Agent. Your role is to:
...
RAG_QUERY_ENHANCEMENT_PROMPT = """Given this Jira ticket information, generate an optimized search query for retrieving relevant historical documentation:
